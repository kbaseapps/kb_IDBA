...
sub new
{
    ...
    my $self = {
	client => kb_IDBA::kb_IDBAClient::RpcClient->new,
	url => $url,
	headers => [],
    };
...
sub _validate_version {
    ...
    if ($sMinor > $cMinor) {
        warn "New client version available for kb_IDBA::kb_IDBAClient\n";
    }
    if ($sMajor == 0) {
        warn "kb_IDBA::kb_IDBAClient version is $svr_version. API subject to change.\n";
    }
}
...
package kb_IDBA::kb_IDBAClient::RpcClient;
