...
from kb_IDBA.authclient import KBaseAuth as _KBaseAuth
...
def get_config():
    ...
    for nameval in config.items(get_service_name() or 'kb_IDBA'):
        retconfig[nameval[0]] = nameval[1]
    return retconfig

config = get_config()

from kb_IDBA.kb_IDBAImpl import kb_IDBA  # noqa @IgnorePep8
impl_kb_IDBA = kb_IDBA(config)
...
class Application(object):
    ...
    def __init__(self):
        submod = get_service_name() or 'kb_IDBA'
